...
const About = () => {
  ...
  return (
    <div className="section text-left p-4 border-b border-slate-300 cursor-pointer" data-section="about" onClick={handleSectionClick}>
      ...
      <TransitionGroup>
        {isOpen && (
          <CSSTransition timeout={200} classNames="my-node">
            <section id="about" className='mt-3 mb-3'>
              <h2>
